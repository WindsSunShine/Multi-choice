...
@property(nonatomic,strong)NSMutableArray * section4Array;
@property(nonatomic,strong)NSMutableArray * section5Array;
...
-(NSMutableArray *)section3Array {
    ...
    if (_section3Array == nil) {
        self.section3Array = [NSMutableArray array];
    }
    return  _section3Array;
    
}
-(NSMutableArray *)section4Array {
    
    if (_section4Array == nil) {
        self.section4Array = [NSMutableArray array];
    }
    return  _section4Array;
    
}
-(NSMutableArray *)section5Array {
    
    if (_section5Array == nil) {
        self.section5Array = [NSMutableArray array];
    }
    return  _section5Array;
...
- (UIView *)addTableHeaderView {
    ...
    subtitleLabel.text = @"超出默认行数,出现\"更多\"按钮,点击展开";
...
//    NSLog(@"%@",[self.dataSourceDic objectForKey:sectionTitle]);
    ...
    for (NSString * s in [self.dataSourceDic objectForKey:sectionTitle]) {
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    switch (indexPath.section) {
        case 0:
            ...
            if (self.section1Array.count != 0) {
                
                if ([self.section1Array containsObject:_cellTitle]) {
                    
                    [self.section1Array removeObject:_cellTitle];
                }else{
                    
                    [self.section1Array addObject:_cellTitle];
                }
...
#pragma mark -------  创建存储的字典 ，传给后台，约定传递的数据
            ...
            [self.dataSourceDic setValue:self.section1Array forKey:sectionTitle];
            break;
        case 1:
            
            if (self.section2Array.count != 0) {
                
                if ([self.section2Array containsObject:_cellTitle]) {
                    
                    [self.section2Array removeObject:_cellTitle];
                }else{
                    
                    [self.section2Array addObject:_cellTitle];
                }
...
#pragma mark -------  创建存储的字典 ，传给后台，约定传递的数据
            ...
            [self.dataSourceDic setValue:self.section2Array forKey:sectionTitle];
            break;
        case 2:
            
            if (self.section3Array.count != 0) {
                
                if ([self.section3Array containsObject:_cellTitle]) {
                    
                    [self.section3Array removeObject:_cellTitle];
                }else{
                    
                    [self.section3Array addObject:_cellTitle];
                }
...
#pragma mark -------  创建存储的字典 ，传给后台，约定传递的数据
            ...
            [self.dataSourceDic setValue:self.section3Array forKey:sectionTitle];
            break;
        case 3:
            
            if (self.section4Array.count != 0) {
                
                if ([self.section4Array containsObject:_cellTitle]) {
                    
                    [self.section4Array removeObject:_cellTitle];
                }else{
                    
                    [self.section4Array addObject:_cellTitle];
                }
...
#pragma mark -------  创建存储的字典 ，传给后台，约定传递的数据
            ...
            [self.dataSourceDic setValue:self.section4Array forKey:sectionTitle];
            break;
        case 4:
            
            if (self.section5Array.count != 0) {
                
                if ([self.section5Array containsObject:_cellTitle]) {
                    
                    [self.section5Array removeObject:_cellTitle];
                }else{
                    
                    [self.section5Array addObject:_cellTitle];
                }
...
#pragma mark -------  创建存储的字典 ，传给后台，约定传递的数据
            ...
            [self.dataSourceDic setValue:self.section5Array forKey:sectionTitle];
...
-(void)filterFootViewCleanClicked:(id)sender{
    ...
    [self.section3Array removeAllObjects];
    [self.section4Array removeAllObjects];
    [self.section5Array removeAllObjects];
